...
export const LOCAL_COLLECTION_MEMBERSHIP: Record<string, CollectionSlug[]> = {
  'PS-TEE-CRT-WHT': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TEES],
  'PS-TEE-CRT-RED': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TEES],
  'PS-TEE-INS-PRP': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TEES],
  'PS-TNK-STR-BLK': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TANKS],
  'PS-TNK-STR-WHT': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TANKS],
  'PS-PNT-CORE-BLK': [COLLECTION_SLUG.PANTS],
  'PS-PNT-CORE-CRM': [COLLECTION_SLUG.PANTS],
  'PS-PNT-CARP-GRY': [COLLECTION_SLUG.PANTS],
  'PS-PNT-CARP-GRN': [COLLECTION_SLUG.PANTS],
  'PS-TEE-WAR-BRW': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.TEES],
  'stick-no-bills': [COLLECTION_SLUG.LATEST, COLLECTION_SLUG.LONG_SLEEVE],

  // Backwards compatibility for old fallback lookups
