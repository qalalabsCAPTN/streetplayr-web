...
export default function ProtoCoreCollection() {
  ...
  const filters = ["all", "tops", "outer", "bottoms", "lab"];
  ...
  return (
    <div
      className="min-h-screen bg-[#16111b] text-[#eadfed]"
    ...
    >
      ...
      <header className="fixed top-0 w-full z-50 bg-[#16111b]/80 backdrop-blur-md border-b border-[#4d4354]">
        <div className="flex justify-between items-center px-4 md:px-16 h-20 max-w-7xl mx-auto w-full">
          <div className="text-4xl text-[#ddb7ff]" style={{ fontFamily: "'Anton', sans-serif", letterSpacing: "0.02em" }}>
            StreetplayR
          </div>
          ...
          <nav className="hidden md:flex gap-8">
            <a
              href="#"
              className="text-xs uppercase text-[#ddb7ff] border-b-2 border-[#ddb7ff] pb-1"
            ...
            <a
              href="#"
              className="text-xs uppercase text-[#cfc2d6] hover:text-[#ddb7ff] transition-colors"
              style={{ fontFamily: "'Space Mono', monospace" }}
            >
              Archive
            </a>
          ...
          <div className="flex items-center gap-6">
            <button className="text-[#ddb7ff] hover:text-shadow transition-all">🛒</button>
            <button className="text-[#ddb7ff] hover:text-shadow transition-all">💳</button>
          </div>
        </div>
      </header>
      ...
      <section className="relative w-full h-[400px] overflow-hidden border-b border-[#4d4354] mt-20">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <p
            className="text-xs text-[#ddb7ff] uppercase tracking-widest animate-pulse"
            style={{ fontFamily: "'Space Mono', monospace" }}
          >
      ...
      {/* Main Content */}
      <main className="pb-24 w-full max-w-7xl mx-auto px-4 md:px-16 pt-12">
        {/* HUD Header */}
        <div className="mb-12 border-l-4 border-[#ddb7ff] pl-6">
          <h1
            className="text-5xl md:text-7xl uppercase leading-none tracking-tight mb-8"
          ...
          <div className="flex flex-wrap gap-2">
            {filters.map((filter) => (
              <button
                ...
                className={`px-4 py-2 text-xs uppercase transition-all ${
                  activeFilter === filter
                    ? "bg-[#ddb7ff] text-[#490080]"
                    : "border border-[#39323d] text-[#eadfed] hover:border-[#ddb7ff]"
                }`}
                style={{ fontFamily: "'Archivo Black', sans-serif" }}
              >
                {filter === "lab" ? (
                  <span className="text-[#ffb59e]">{filter}</span>
                ) : (
                  filter
                )}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((product) => (
            <div
              key={product.id}
              className="group relative border border-[#39323d] bg-[#110c15] transition-all hover:border-[#ddb7ff]"
            >
              {/* Badge */}
              {product.badge && (
              ...
              {/* Image Container */}
              <div className="relative aspect-[4/5] overflow-hidden bg-[#1f1a23]">
                <img
                  alt={product.name}
                  src={product.image}
              ...
              {/* Product Info */}
              <div className="p-6 border-t border-[#39323d]">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <p
                      className="text-xs text-[#ddb7ff] uppercase"
                      style={{ fontFamily: "'Space Mono', monospace" }}
                    >
                      {product.model}
                    </p>
                  ...
                  <span
                    className="text-2xl text-[#ffb59e]"
                    style={{ fontFamily: "'Anton', sans-serif" }}
                  >
                    {product.price}
                  </span>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-2">
                    <span className="text-xs opacity-50" role="img" aria-label="data">📊</span>
                    <span
                  ...
                  <button
                    className="bg-[#ddb7ff]/10 border border-[#ddb7ff]/20 hover:bg-[#ddb7ff] hover:text-[#490080] px-4 py-2 text-xs uppercase transition-all"
                    style={{ fontFamily: "'Archivo Black', sans-serif" }}
                  >
                    Select
                  </button>
        ...
        <div className="mt-20 flex flex-col items-center gap-6">
          <div className="flex items-center gap-4">
            <button className="w-10 h-10 border border-[#39323d] flex items-center justify-center hover:border-[#ddb7ff] transition-all">
              ◀
            </button>
            ...
            >
              ...
              <span className="opacity-50 hover:text-[#ddb7ff] transition-all cursor-pointer">
                02
              </span>
              <span className="opacity-30">/</span>
              <span className="opacity-50 hover:text-[#ddb7ff] transition-all cursor-pointer">
          ...
          <div className="w-full max-w-xs h-px bg-[#39323d] relative">
      ...
      {/* Footer */}
      <footer className="w-full py-12 px-4 md:px-16 border-t border-[#39323d] bg-[#110c15]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
          <div
            className="text-4xl text-[#eadfed]"
          ...
          <div className="flex gap-8">
            <a
              href="#"
              className="text-xs text-[#cfc2d6] hover:text-[#ffb59e] transition-all opacity-80 hover:opacity-100"
              style={{ fontFamily: "'Space Mono', monospace" }}
            >
              Terms
            </a>
          ...
          <div
            ...
            style={{ fontFamily: "'Space Mono', monospace" }}
          >
            © 2024 STREETPLAYR // CORE_OS_V1.0
          </div>
        </div>
      </footer>

      {/* Decorative HUD */}
      <div className="fixed top-32 left-6 hidden xl:block pointer-events-none">
        <div
          className="text-[10px] opacity-20 -rotate-90 origin-left"
          style={{ fontFamily: "'Space Mono', monospace" }}
        >
      ...
      <div className="fixed bottom-32 right-6 hidden xl:block pointer-events-none text-right">
        <div
          className="text-[10px] opacity-20"
          style={{ fontFamily: "'Space Mono', monospace" }}
        >
          [ REC ] SYSTEM_STATUS_OK
          <br />
