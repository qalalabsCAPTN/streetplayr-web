...
export default function ForgotPasswordPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="relative min-h-screen bg-transparent flex items-center justify-center overflow-hidden pt-20">
                ...
                {sent ? (
                  <div className="space-y-6 text-center">
                    ...
                    <div className="space-y-2">
                      <p className="font-mono text-[12px] text-[#eadfed] tracking-[0.12em] uppercase">Check your email</p>
                  ...
                  <div className="space-y-5">
                    <p className="font-mono text-[11px] text-white/50 tracking-[0.1em] leading-relaxed">
                      Enter email address. We will send a reset link.
                    </p>
