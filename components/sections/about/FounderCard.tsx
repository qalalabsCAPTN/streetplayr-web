...
export default function FounderCard() {
  return (
    <section className="relative py-20 sm:py-28 md:py-36 px-4 md:px-8 lg:px-12 w-full max-w-[min(98vw,2560px)] mx-auto border-t border-[var(--fg-04)]">
      <FadeIn>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,520px)_1fr] gap-10 lg:gap-16 items-start">
        <FadeIn>
          <div className="relative overflow-hidden bg-[var(--panel)] border border-[var(--fg-06)] rounded-xl">
            ...
            <div className="px-6 py-4 border-t border-[var(--fg-05)] flex items-center justify-between gap-3">
              <span className="font-mono text-[8px] uppercase tracking-[0.3em] text-[#ddb7ff]/50 leading-relaxed">Founder // Creative Director</span>
              <span className="font-mono text-[7px] uppercase tracking-[0.3em] text-[var(--fg-15)] flex-shrink-0">Est. 2024</span>
            </div>
          </div>
        </FadeIn>

        <FadeIn delay={0.2} className="flex flex-col justify-start lg:pt-3">
            <p className="font-body text-[15px] sm:text-[17px] leading-[1.85] sm:leading-[1.9] text-[var(--fg-65)] tracking-wide">
            ...
            <p className="font-body text-[14px] leading-[1.85] sm:leading-[1.9] text-[var(--fg-45)] mt-6 sm:mt-8 tracking-wide">
            ...
            <div className="mt-10 sm:mt-14 pt-6 border-t border-[var(--fg-06)]">
              <span className="font-display text-[28px] sm:text-[40px] uppercase text-[var(--fg)] leading-[1.1] block tracking-[0.01em]">
                The Streets
              </span>
