...
export default function CategoryScroll() {
  ...
  return (
    <section ref={containerRef} className="w-full bg-transparent py-24 overflow-hidden text-[var(--sp-accent)] flex flex-col gap-4 md:gap-8 border-y border-white/10">
