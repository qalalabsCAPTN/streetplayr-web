...
export default function SocialProof() {
  ...
  return (
    <section ref={containerRef} className="w-full bg-[#050505] py-40 px-4 md:px-8 lg:px-16 overflow-hidden border-t border-white/5">
      <div className="flex flex-col items-center mb-32 text-center relative z-10">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#d4ff1e]"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {instagramPosts.map((post, index) => (
            <motion.div
              ...
              className={`group relative aspect-[3/4] overflow-hidden bg-[#111] cursor-none rounded-sm ${post.className}`}
              data-cursor="product"
            >
              <Image
                src={post.image}
